...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 202.22 // mm
  ...
  #define DELTA_RADIUS 103.12 //(DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)
...
// For deltabots this means top and center of the Cartesian print volume.
  ...
  #define MANUAL_Z_HOME_POS 185.50 // For delta: Distance between nozzle and print surface after homing.
#endif
...
#define HOMING_FEEDRATE_XYZ (200*12)
#define HOMING_FEEDRATE_E 0
#define HOMING_FEEDRATE { HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_XYZ, HOMING_FEEDRATE_E }

// default settings
// delta speeds must be the same on xyz
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 95}  // default steps per unit for Kossel (GT2, 20 tooth)
